...
make release_linux  # -> build/linux/emperor_penguin_llvmir_emitter, build/linux/libemperorpenguin.penguin-lib, build/linux/emperor
make release_win    # -> build/win/emperor_penguin_llvmir_emitter.exe, build/win/emperor.bat (linux host cross-compiles via emperor)
