...
// sw/* + ../../EmperorPenguin/others/libpenguin-esl/*.penguin, flags
// --enable-coroutine --meta-with-user-sources). This file contributes no
// definitions on top of the project.
```

## Compile
Args: `Examples/tinyriscv/tinyriscv.penguins --enable-coroutine --meta-with-user-sources`
Env: ``
ExpectedExitCode: 0
