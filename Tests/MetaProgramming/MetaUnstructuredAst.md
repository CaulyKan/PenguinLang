...
#fun echo_raw(fmt: string, raw: unstructured_ast) -> ast {
    return #create_expression("println(\"" + raw + "\")");
}
initial {
    let a: i32 = 10;
    let b: i32 = 20;
