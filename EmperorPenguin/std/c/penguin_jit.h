...
/* Create a new JIT session. Returns NULL on failure (call _emperor_penguin_jit_get_error
 * for details). The returned context must be destroyed with _emperor_penguin_jit_destroy. */
...
int64_t _emperor_penguin_jit_call_i64_i64_i64_i64(void* fn, int64_t a, int64_t b, int64_t c);
